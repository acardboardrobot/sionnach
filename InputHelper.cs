...
namespace Sionnach
{
    public enum MouseButtons { LeftButton, RightButton, MiddleButton }
    public class InputHelper
    {
        ...
        public float mouseWheelDelta = 0.0f;
        ...
        public InputHelper(StateManager StateManager)
        {
        ...
        public void InspectGamePad(PlayerIndex playerNum)
        ...
        public void Update(GameTime gameTime)
        {
            ...
            mouseWheelDelta = currentMouseState.ScrollWheelValue - lastMouseState.ScrollWheelValue;
